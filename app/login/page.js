...
export default function Login() {
  ...
  return (
    <AnimatedPage className="flex min-h-[calc(100vh-8rem)] items-center justify-center py-10">
      <div className="w-full max-w-md glass-card rounded-3xl p-8 relative overflow-hidden border border-primary/20">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button type="button" onClick={() => googleLogin()} variant="outline" className="h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 text-foreground backdrop-blur-sm">
