...
export default function MapPage() {
  ...
  return (
    <AnimatedPage className="px-4 md:px-0 mt-8 md:mt-10 max-w-7xl mx-auto w-full md:h-[calc(100vh-8rem)] flex flex-col-reverse md:flex-row gap-6 md:gap-10 lg:gap-14">
